...
function AddKey({ children, ...props }: AddKeyProps) {
  return (
    <div
      {...props}
      className="flex bg-pink-500 w-full h-full rounded-sm sm:rounded-md items-center justify-center cursor-pointer select-none opacity-50 hover:opacity-95 transition-all active:scale-125 font-bold"
    >
      +
    </div>
  )
